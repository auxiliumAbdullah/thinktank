...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('notices/like', [NoticeController::class, 'likeNotices'])->name('notice.like');
    Route::post('notices/comment', [NoticeController::class, 'commentNotices'])->name('notice.comment');
    Route::get('notices/delete/{id}', [NoticeController::class, 'deleteNotices'])->name('notice.delete');
