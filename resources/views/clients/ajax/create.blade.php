                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.text fieldId="lastname" :fieldLabel="__('modules.client.clientLastName')" fieldName="lastname"
                                    fieldRequired="true" :fieldPlaceholder="__('placeholders.lastname')"
                                    :fieldValue="$lead->client_lastname ?? ''"></x-forms.text>
                            </div>
                            <div class="col-md-4">
