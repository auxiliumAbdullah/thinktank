            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                      ...
                      <div class="col-lg-4 col-md-6">
                        <x-forms.text :fieldLabel="__('modules.lead.clientLastName')" fieldName="client_lastname"
                            fieldId="client_lastname" fieldPlaceholder="" fieldRequired="true"
                            :fieldValue="$lead->client_lastname" />
                    </div>
