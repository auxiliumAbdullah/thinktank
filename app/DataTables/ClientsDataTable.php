...
class ClientsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->addColumn('lastname', function ($row) {
        ...
        $datatables->rawColumns(['name','lastname', 'action', 'status', 'check']);
        return $datatables;
    }
    ...
    public function query(User $model)
    {
        ...
        $users = $model->withoutGlobalScope('active')->with('session', 'clientDetails', 'clientDetails.addedBy')
            ...
            ->select('users.id', 'users.name', 'users.lastname','client_details.company_name', 'users.email', 'users.mobile', 'users.image', 'users.created_at', 'users.status', 'client_details.added_by', 'users.admin_approval')
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('app.customers')  => ['data' => 'client_name', 'name' => 'users.name', 'visible' => false, 'title' => __('app.customers')],
             __('app.lastname') => ['data' => 'lastname', 'name' => 'lastname', 'title' => __('app.lastname')],
