...
class LeadsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        foreach ($customFields as $customField) {
            ...
            $datatables->rawColumns(['status', 'action', 'client_name','client_lastname', 'next_follow_up_date', 'agent_name', 'check', 'mobile']);
    ...
    public function query(Lead $model)
    {
        ...
        if ($this->request()->searchText != '') {
            $lead = $lead->where(function ($query) {
                ...
                ->orWhere('leads.client_lastname', 'like', '%' . request('searchText') . '%')
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('app.lastname') => ['data' => 'client_lastname', 'name' => 'client_lastname', 'exportable' => false, 'title' => __('app.lastname')],
